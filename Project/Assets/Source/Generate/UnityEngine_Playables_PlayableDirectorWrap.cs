...
public class UnityEngine_Playables_PlayableDirectorWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("DeferredEvaluate", new LuaCSFunction(DeferredEvaluate));
		L.RegFunction("Play", new LuaCSFunction(Play));
		L.RegFunction("SetGenericBinding", new LuaCSFunction(SetGenericBinding));
		...
		L.RegFunction("RebuildGraph", new LuaCSFunction(RebuildGraph));
		L.RegFunction("ClearReferenceValue", new LuaCSFunction(ClearReferenceValue));
		L.RegFunction("SetReferenceValue", new LuaCSFunction(SetReferenceValue));
		L.RegFunction("GetReferenceValue", new LuaCSFunction(GetReferenceValue));
		L.RegFunction("GetGenericBinding", new LuaCSFunction(GetGenericBinding));
		L.RegFunction("ClearGenericBinding", new LuaCSFunction(ClearGenericBinding));
		L.RegFunction("RebindPlayableGraphOutputs", new LuaCSFunction(RebindPlayableGraphOutputs));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_Playables_PlayableDirector));
		L.RegFunction("__eq", new LuaCSFunction(op_Equality));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("state", new LuaCSFunction(get_state), null);
		L.RegVar("extrapolationMode", new LuaCSFunction(get_extrapolationMode), new LuaCSFunction(set_extrapolationMode));
		L.RegVar("playableAsset", new LuaCSFunction(get_playableAsset), new LuaCSFunction(set_playableAsset));
		...
		L.RegVar("timeUpdateMode", new LuaCSFunction(get_timeUpdateMode), new LuaCSFunction(set_timeUpdateMode));
		L.RegVar("time", new LuaCSFunction(get_time), new LuaCSFunction(set_time));
		L.RegVar("initialTime", new LuaCSFunction(get_initialTime), new LuaCSFunction(set_initialTime));
		L.RegVar("duration", new LuaCSFunction(get_duration), null);
		L.RegVar("played", new LuaCSFunction(get_played), new LuaCSFunction(set_played));
		L.RegVar("paused", new LuaCSFunction(get_paused), new LuaCSFunction(set_paused));
		L.RegVar("stopped", new LuaCSFunction(get_stopped), new LuaCSFunction(set_stopped));
		L.EndClass();
	}
	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				UnityEngine.Playables.PlayableDirector obj = (UnityEngine.Playables.PlayableDirector)ToLua.CheckObject<UnityEngine.Playables.PlayableDirector>(L, 1);
				UnityEngine.Playables.PlayableAsset arg0 = (UnityEngine.Playables.PlayableAsset)ToLua.CheckObject<UnityEngine.Playables.PlayableAsset>(L, 2);
				UnityEngine.Playables.DirectorWrapMode arg1 = (UnityEngine.Playables.DirectorWrapMode)ToLua.CheckObject(L, 3, TypeTraits<UnityEngine.Playables.DirectorWrapMode>.type);
				obj.Play(arg0, arg1);
				return 0;
			}
			else
	...
	static int set_extrapolationMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Playables.PlayableDirector obj = (UnityEngine.Playables.PlayableDirector)o;
			UnityEngine.Playables.DirectorWrapMode arg0 = (UnityEngine.Playables.DirectorWrapMode)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Playables.DirectorWrapMode>.type);
	...
	static int set_timeUpdateMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Playables.PlayableDirector obj = (UnityEngine.Playables.PlayableDirector)o;
			UnityEngine.Playables.DirectorUpdateMode arg0 = (UnityEngine.Playables.DirectorUpdateMode)ToLua.CheckObject(L, 2, TypeTraits<UnityEngine.Playables.DirectorUpdateMode>.type);
