...
public class Sango_Tools_RectWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Sango.Tools.Rect), null);
		...
		L.RegFunction("New", new LuaCSFunction(_CreateSango_Tools_Rect));
	...
	static int _CreateSango_Tools_Rect(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Sango.Tools.Rect arg0 = StackTraits<Sango.Tools.Rect>.Check(L, 1);
				Sango.Tools.Rect obj = new Sango.Tools.Rect(arg0);
			...
			else if (count == 2)
			{
				...
				Sango.Tools.Rect obj = new Sango.Tools.Rect(arg0, arg1);
				ToLua.PushValue(L, obj);
				return 1;
			}
			else if (count == 4)
			{
				...
				Sango.Tools.Rect obj = new Sango.Tools.Rect(arg0, arg1, arg2, arg3);
				ToLua.PushValue(L, obj);
				return 1;
			}
			else if (count == 0)
			{
				Sango.Tools.Rect obj = new Sango.Tools.Rect();
				ToLua.PushValue(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: Sango.Tools.Rect.New");
			}
		}
		catch (Exception e)
		{
	...
	static int MinMaxRect(IntPtr L)
	{
		try
		{
			...
			float arg2 = (float)LuaDLL.luaL_checknumber(L, 3);
			float arg3 = (float)LuaDLL.luaL_checknumber(L, 4);
			Sango.Tools.Rect o = Sango.Tools.Rect.MinMaxRect(arg0, arg1, arg2, arg3);
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int Set(IntPtr L)
	{
		try
		{
			...
			Sango.Tools.Rect obj = (Sango.Tools.Rect)ToLua.CheckObject(L, 1, TypeTraits<Sango.Tools.Rect>.type);
	...
	static int Contains(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<Sango.Tools.Rect>(L, 2))
			{
				Sango.Tools.Rect obj = (Sango.Tools.Rect)ToLua.CheckObject(L, 1, TypeTraits<Sango.Tools.Rect>.type);
				Sango.Tools.Rect arg0 = StackTraits<Sango.Tools.Rect>.To(L, 2);
				bool o = obj.Contains(arg0);
				LuaDLL.lua_pushboolean(L, o);
				ToLua.SetBack(L, 1, obj);
				return 1;
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Sango.Tools.Rect.Contains");
			}
		}
		catch (Exception e)
		{
	...
	static int Overlaps(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Sango.Tools.Rect.Overlaps");
			}
		}
		catch (Exception e)
		{
	...
	static int NormalizedToPoint(IntPtr L)
	{
		try
		{
			...
			Sango.Tools.Rect arg0 = StackTraits<Sango.Tools.Rect>.Check(L, 1);
			UnityEngine.Vector2 arg1 = ToLua.ToVector2(L, 2);
			UnityEngine.Vector2 o = Sango.Tools.Rect.NormalizedToPoint(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int PointToNormalized(IntPtr L)
	{
		try
		{
			...
			Sango.Tools.Rect arg0 = StackTraits<Sango.Tools.Rect>.Check(L, 1);
			UnityEngine.Vector2 arg1 = ToLua.ToVector2(L, 2);
			UnityEngine.Vector2 o = Sango.Tools.Rect.PointToNormalized(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	static int op_Equality(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			Sango.Tools.Rect arg0 = StackTraits<Sango.Tools.Rect>.To(L, 1);
			Sango.Tools.Rect arg1 = StackTraits<Sango.Tools.Rect>.To(L, 2);
			bool o = arg0 == arg1;
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
	...
	static int Equals(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<Sango.Tools.Rect>(L, 2))
			{
				Sango.Tools.Rect obj = (Sango.Tools.Rect)ToLua.CheckObject(L, 1, TypeTraits<Sango.Tools.Rect>.type);
				Sango.Tools.Rect arg0 = StackTraits<Sango.Tools.Rect>.To(L, 2);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Sango.Tools.Rect.Equals");
			}
		}
		catch (Exception e)
		{
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: Sango.Tools.Rect.ToString");
			}
		}
		catch (Exception e)
		{
	...
	static int get_zero(IntPtr L)
	{
		try
		{
			ToLua.PushValue(L, Sango.Tools.Rect.zero);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_x(IntPtr L)
	{
		...
		try
		{
			...
			Sango.Tools.Rect obj = (Sango.Tools.Rect)o;
			float ret = obj.x;
