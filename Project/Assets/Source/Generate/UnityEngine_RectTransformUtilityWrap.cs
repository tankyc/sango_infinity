...
public class UnityEngine_RectTransformUtilityWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("PixelAdjustRect", new LuaCSFunction(PixelAdjustRect));
		L.RegFunction("RectangleContainsScreenPoint", new LuaCSFunction(RectangleContainsScreenPoint));
		L.RegFunction("ScreenPointToWorldPointInRectangle", new LuaCSFunction(ScreenPointToWorldPointInRectangle));
		L.RegFunction("ScreenPointToLocalPointInRectangle", new LuaCSFunction(ScreenPointToLocalPointInRectangle));
		...
		L.RegFunction("CalculateRelativeRectTransformBounds", new LuaCSFunction(CalculateRelativeRectTransformBounds));
		L.RegFunction("FlipLayoutOnAxis", new LuaCSFunction(FlipLayoutOnAxis));
		L.RegFunction("FlipLayoutAxes", new LuaCSFunction(FlipLayoutAxes));
	...
	static int PixelAdjustPoint(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Canvas arg2 = (UnityEngine.Canvas)ToLua.CheckObject<UnityEngine.Canvas>(L, 3);
	...
	static int PixelAdjustRect(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Canvas arg1 = (UnityEngine.Canvas)ToLua.CheckObject<UnityEngine.Canvas>(L, 2);
