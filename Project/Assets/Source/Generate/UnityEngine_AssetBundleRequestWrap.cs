...
public class UnityEngine_AssetBundleRequestWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.AssetBundleRequest), typeof(UnityEngine.ResourceRequest));
		L.RegFunction("New", new LuaCSFunction(_CreateUnityEngine_AssetBundleRequest));
		L.RegFunction("__tostring", new LuaCSFunction(ToLua.op_ToString));
		L.RegVar("asset", new LuaCSFunction(get_asset), null);
		L.RegVar("allAssets", new LuaCSFunction(get_allAssets), null);
		L.EndClass();
	}
