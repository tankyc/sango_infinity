...
public class DG_Tweening_TweenTypeWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("Tweener", new LuaCSFunction(get_Tweener), null);
		L.RegVar("Sequence", new LuaCSFunction(get_Sequence), null);
		L.RegVar("Callback", new LuaCSFunction(get_Callback), null);
	...
	static Type TypeOf_DG_Tweening_TweenType = typeof(DG.Tweening.TweenType);

	static bool CheckType(IntPtr L, int pos)
	{
		return TypeChecker.CheckEnumType(TypeOf_DG_Tweening_TweenType, L, pos);
	}
