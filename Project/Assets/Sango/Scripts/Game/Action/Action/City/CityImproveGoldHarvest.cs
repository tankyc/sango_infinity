...
namespace Sango.Core.Action
{
    ...
    /// jobIds: 工作ID集合
    /// </summary>
    public class CityImproveGoldHarvest : CityActionBase
    {
        /// <summary>
        /// 提升百分比
        /// </summary>
        ...
        public override void Init(JObject p, params SangoObject[] sangoObjects)
        {
            ...
            GameEvent.OnCityCalculateGoldHarvest += OnCityCalculateGoldHarvest;
        }
        ...
        void OnCityCalculateGoldHarvest(City city, OverrideData<int> overrideData)
        {
            if (City != city) return;
