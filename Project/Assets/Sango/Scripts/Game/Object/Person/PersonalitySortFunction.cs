...
namespace Sango.Core
{
    ...
    public class PersonalitySortFunction : Singleton<PersonalitySortFunction>
    {
        ...
        /// 获取性格对象显示字符串的代理
        /// </summary>
        /// <param name="PersonalityId">性格对象</param>
        /// <returns>显示字符串</returns>
        public delegate string PersonalityValueStrGet(Personality PersonalityId);
        ...
        /// <param name="PersonalityId">性格对象</param>
        /// <returns>属性值</returns>
        public delegate object PersonalityValueObjGet(Personality PersonalityId);
        ...
        public delegate void PersonalityValueObjSet(Personality PersonalityId, object value);
