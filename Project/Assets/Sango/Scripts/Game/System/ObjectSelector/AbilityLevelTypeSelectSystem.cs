...
{
    /// <summary>
    /// 能力等级选择系统，用于在通用对象选择窗口中选择能力等级
    /// </summary>
    [GameSystem]
    public class AbilityLevelTypeSelectSystem : ObjectSelectSystem, IObjectSelectSystem<AbilityLevelType>
    {
        /// <summary>
        /// 通用对象选择接口实现 - 供UIDataEdit按数据集类型统一调用
        /// </summary>
        void IObjectSelectSystem<AbilityLevelType>.Start(List<AbilityLevelType> candidates, List<AbilityLevelType> resultList, int limit, Action<List<AbilityLevelType>> action, List<ObjectSortTitle> customSortTitles, string cutomSortTitleName)
        {
        ...
        /// 选择完成后的回调
        /// </summary>
        Action<List<AbilityLevelType>> finishAction;
        ...
        /// 默认排序标题组名称
        /// </summary>
        public string defualtTitleName = "能力等级";

        /// <summary>
        /// 默认排序标题列表
        /// </summary>
        public List<ObjectSortTitle> defualtTitleList = AbilityLevelTypeSortFunction.DefaultSortList;
        ...
        /// 启动能力等级选择系统
        /// </summary>
        /// <param name="abilityLevelTypes">候选能力等级列表</param>
        /// <param name="resultList">已选中的能力等级列表</param>
        ...
        public void Start(List<AbilityLevelType> abilityLevelTypes, List<AbilityLevelType> resultList, int limit, Action<List<AbilityLevelType>> action, List<ObjectSortTitle> customSortTitles, string cutomSortTitleName, int sortIndex = 1)
        {
            donotFinishThisSystem = false;
            selectLimit = Math.Min(limit, abilityLevelTypes.Count);
            Objects = new List<SangoObject>(abilityLevelTypes);
            finishAction = action;
