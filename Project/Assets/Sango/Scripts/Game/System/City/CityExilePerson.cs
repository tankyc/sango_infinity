...
namespace Sango.Core.Player
{
    ...
    public class CityExilePerson : CityBaseSystem
    {
        ...
        void OnPersonSelected(List<Person> person_list)
        {
            ...
            GameDialog.IDialog dialog1 = GameDialog.Open(GameDialog.DialogStyle.ClickPersonSay, $"再见了!", () =>
            {
                string content = "";
                ...
                GameDialog.Open(GameDialog.DialogStyle.ClickSay, content, () =>
                {
            ...
            dialog1.SetPerson(person_list[0]);
        }
