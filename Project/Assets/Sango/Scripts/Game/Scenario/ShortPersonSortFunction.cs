...
//{
//    public class ShortPersonSortFunction : Singleton<ShortPersonSortFunction>
//    {
//        public delegate string PersonValueStrGet(ShortPerson person);
//        public delegate int PersonValueGet(ShortPerson person);
//        public delegate int PersonSortFunc(ShortPerson person1, ShortPerson person2);
...
//        /// <returns>属性值</returns>
//        public delegate object PersonValueObjGet(ShortPerson person);
...
//        public delegate void PersonValueObjSet(ShortPerson person, object value);
...
//            {
//                return valueObjGet?.Invoke((ShortPerson)obj);
//            }

//            public override void SetValue(SangoObject obj, object value)
//            {
//                valueObjSet?.Invoke((ShortPerson)obj, value);
//            }

//            public override string GetValueStr(SangoObject obj)
//            {
//                return valueGetCall.Invoke((ShortPerson)obj);
//            }

//            public override int Sort(SangoObject a, SangoObject b)
//            {
//                return personSortFunc.Invoke((ShortPerson)a, (ShortPerson)b);
//            }
...
//            name = "所属",
//            width = 5.00f,
//            valueGetCall = x => x.BelongCityId > 0 ? ShortScenario.CurSelected.citySet[x.BelongCityId].Name : "",
//            personSortFunc = (a, b) => a.BelongCityId.CompareTo(b.BelongCityId),
//            valueObjGet = x => x.BelongCityId,
//            valueObjSet = null,
//        };
...
//                if(x.BelongForceId > 0)
//                {
//                    return ShortScenario.CurSelected.forceSet[x.BelongForceId].Name;
//                }
//                else
//                {
//                    return "";
...
//        {
//                ShortPersonSortFunction.SortByName,
//                ShortPersonSortFunction.SortByYearBorn,
//                ShortPersonSortFunction.SortByYearDead,
//                ShortPersonSortFunction.SortBySex ,
//                ShortPersonSortFunction.SortByCommand,
//                ShortPersonSortFunction.SortByStrength,
//                ShortPersonSortFunction.SortByIntelligence,
//                ShortPersonSortFunction.SortByPolitics,
//                ShortPersonSortFunction.SortByGlamour,
//        };
