...
namespace Sango.Core
{
    public abstract class SkillEffect
    {
        public struct SkillEffectConditionDatabase : IConditionDatabase
        {
            ...
            public City ActionCity => self.master.master.mBelongCity;
            public City TargetCity => atk_cell.troop?.mBelongCity ?? atk_cell.building?.mBelongCity;
            public Corps ActionCorps => self.master.master.mBelongCorps;
            public Corps TargetCorps => atk_cell.troop?.mBelongCorps ?? atk_cell.building?.mBelongCorps;
            public Force ActionForce => self.master.master.mBelongForce;
